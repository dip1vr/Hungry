...
import 'package:hungry/features/dashboard/pages/restaurant_details_page.dart';
...
class RestaurantCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        Get.to(
          () => RestaurantDetailsPage(data: data, restaurantId: restaurantId),
        );
      },
      child: Container(
        width: 300,
                    ...
                    children: [
                      ...
                      Obx(() {
                        ...
                        return GestureDetector(
                          ...
                          onTap: () {
                            print("Heart icon tapped for $restaurantId");
