...
class _PromoCarouselState extends State<PromoCarousel> {
  ...
  void initState() {
    super.initState();
    // Start at a very high number to allow "infinite" scrolling in both directions effectively
    // effectively simulating infinite forward scroll from start.
    // Ensure we start at a multiple of length so we start at index 0 data.
    int initialPage = 1000 * _promos.length;
