...
import 'package:hungry/core/services/imgbb_service.dart';
    ...
    try {
      ...
      if (user != null) {
        ...
        if (_profileImage != null) {
          ...
          try {
            final imageUrl = await ImgBBService.uploadImage(_profileImage!);
            if (imageUrl != null) {
              print('✅ Image uploaded successfully: $imageUrl');
              data['profileImage'] = imageUrl;
            } else {
              print('⚠️ Image upload returned null');
            }
          } catch (e) {
        ...
        print('💾 Saving profile data to Firestore: $data');
