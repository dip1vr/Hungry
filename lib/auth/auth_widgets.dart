...
class ModernAuthBackground extends StatelessWidget {
  final Widget child;
  const ModernAuthBackground({Key? key, required this.child}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        Positioned.fill(
          child: Image.network(
            'https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=1920&auto=format&fit=crop', // Dark food background
            fit: BoxFit.cover,
            ...
            errorBuilder: (context, error, stackTrace) => Container(
              color: const Color(0xFF1A1A1A), // Fallback dark color
            ),
          ),
        ),
